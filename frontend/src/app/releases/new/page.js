        ...
        <form onSubmit={handleSubmit} className="bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-lg shadow-2xl p-6 space-y-6">
          ...
          <div className="space-y-6 pt-6 border-t border-gray-600">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">BPM <span className="text-gray-500">(Optional)</span></label>
                <input 
                  type="number" 
                  value={bpm} 
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Key <span className="text-gray-500">(Optional)</span></label>
                <select 
                  value={key} 
          ...
          <div className="flex gap-3 pt-4">
            ...
            <Link href="/" className="px-6 py-3 bg-gray-600 hover:bg-gray-500 text-white rounded-lg transition-all font-medium text-center">Cancel</Link>
          </div>
        </form>
      </div>
    </div>
